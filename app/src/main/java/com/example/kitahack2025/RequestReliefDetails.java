...
public class RequestReliefDetails extends Fragment {
    ...
    public static RequestReliefDetails newInstance(RequestEssential item) {
        RequestReliefDetails fragment = new RequestReliefDetails();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_request_relief_details, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        View contentView = LayoutInflater.from(requireContext())
                .inflate(R.layout.fragment_request_relief_details, null);
        ...
        RecyclerView.Adapter<RecyclerView.ViewHolder> adapter = new RecyclerView.Adapter<RecyclerView.ViewHolder>() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View itemView = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.fragment_request_relief_details, parent, false);
