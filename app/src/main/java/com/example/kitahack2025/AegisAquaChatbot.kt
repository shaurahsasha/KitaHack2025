...
class AegisAquaChatbot {
    ...
    companion object {
        private const val SYSTEM_INSTRUCTIONS = """
            # AegisAqua Assistant System Instructions

            ## App Overview
            AegisAqua is a community-driven donation platform that facilitates food and non-food donations. The app connects donors with recipients and includes features for community events and volunteering opportunities.
            ...
            ```46:63:app/src/main/java/com/example/kitahack2025/RequestFoodFragment.java
            ...
            ```46:63:app/src/main/java/com/example/kitahack2025/RequestNonFoodFragment.java
            ...
            ```56:66:app/src/main/java/com/example/kitahack2025/ProfilePage.java
            ...
            <resources>
                <string name="app_name" translatable="false">AegisAquaApp</string>
                ...
                <string name="app_logo">AegisAqua Logo</string>
            ...
            ```1:68:app/src/main/java/com/example/kitahack2025/User.java
            package com.example.kitahack2025;
            ...
            Remember to maintain a helpful, friendly tone while ensuring users understand both the features and responsibilities of using the AegisAqua platform.
                ...
                <ScrollView
                    ...
                    <LinearLayout
                        ...
                        <LinearLayout
                            ...
                            <ImageView
                                android:id="@+id/ic_aegisaqua_logo"
                                android:layout_width="match_parent"
                                android:layout_height="wrap_content"
