...
public class ShelterMedicalCampFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_shelter_medical_camp, container, false);
...
//        });
        ...
        medicalCampsButton.setBackgroundColor(getResources().getColor(R.color.primary));
        medicalCampsButton.setStrokeColor(ColorStateList.valueOf(getResources().getColor(R.color.primary)));
        medicalCampsButton.setTextColor(Color.WHITE);
        ...
        shelterRepo.getAllShelterItems(new ShelterRepo.OnShelterItemsLoadedListener() {
            ...
            public void onShelterItemsLoaded(List<Shelter> shelters) {
                ...
                allShelters = shelters.stream()
                        .filter(event -> "Volunteering".equalsIgnoreCase(event.getTypeOfShelters()))
